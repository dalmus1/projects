...
Write-Host "Buscando log $StringDay en VMNGPRIIWBP02.ngl.corp"
$FoundedFiles = Get-ChildItem \\VMNGPRIIWBP02.ngl.corp\C$\inetpub\logs\LogFiles\W3SVC1 -Recurse -Include $StringDay
$outputifle = "filter_for_mail_wbp02.log"
