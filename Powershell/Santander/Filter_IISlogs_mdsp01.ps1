...
Write-Host "Buscando log $StringDay en VMNGPRIIMDSP01.ngl.corp"
$FoundedFiles = Get-ChildItem \\VMNGPRIIMDSP01.ngl.corp\C$\inetpub\logs\LogFiles\W3SVC1 -Recurse -Include $StringDay
$outputifle = "filter_for_mail_mdsp01.log"
