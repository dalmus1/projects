...
#COPY HTTP CONFIGS
xcopy /S /X /I E:\LPA_Utils\new_configs\AdapterServicehttpvmngpriimdsp01.web.config E:\LPA\Webapps\adapterserviceHttp\web.config
xcopy /S /X /I E:\LPA_Utils\new_configs\LpaDocServicehttpvmngpriimdsp01.web.config E:\LPA\Webapps\LPADocServiceHttp\web.config
