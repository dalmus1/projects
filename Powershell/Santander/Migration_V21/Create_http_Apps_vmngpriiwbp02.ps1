...
#COPY HTTP CONFIGS
xcopy /S /X /I E:\LPA_Utils\new_configs\AdapterServicehttpvmngpriiwbp02.web.config E:\LPA\Webapps\adapterserviceHttp\web.config
xcopy /S /X /I E:\LPA_Utils\new_configs\LpaDocServicehttpvmngpriiwbp02.web.config E:\LPA\Webapps\LPADocServiceHttp\web.config
